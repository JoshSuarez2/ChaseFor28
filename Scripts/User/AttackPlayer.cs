...
public class AttackPlayer : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip fireballAudio; // sound effect
    ...
    private void Update()
    {
        ...
        if(Input.GetMouseButton(0) && timer > attackDelay && movePlayer.ableToAttack()) 
        {
            Attack();
        }
    ...
    private void Attack()
    {
        SoundManager.instance.PlaySound(fireballAudio);// fireball noise
